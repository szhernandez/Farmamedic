...
public class frmpuntoventa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        panelvariables.setBackground(new java.awt.Color(242, 124, 13));
  ...
  //  logarticulo logart = new logarticulo();
    ...
    private void btnagregarclienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarclienteActionPerformed
       ...
       //Abriendo ventana trabajador
            ...
            frmcliente1.lblaccion.setText("guardar");
            frmcliente1.btnaccion.setText("Guardar");
            frmcliente1.txtid.setVisible(false);
            frmcliente1.lblidcliente.setVisible(false);
            frmcliente1.btneliminar.setVisible(false);
        } catch (Exception e) {
            JOptionPane.showConfirmDialog(null,"Error: " + e);
        }
