...
public class frmclientelistado extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tablaclientes.setSelectionBackground(new java.awt.Color(242, 124, 13));
    ...
    private void tablaclientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaclientesMouseClicked
      if (evt.getClickCount()==1 ) {
        ...
        frmcliente1 ventana = new frmcliente1();
       ...
       //Enviando la accion que se requerira segun la funcion
       frmcliente1.lblaccion.setText("editar");
       frmcliente1.btnaccion.setText("Editar");
       frmcliente1.txtid.setEnabled(false);
       frmcliente1.lblidcliente.setEnabled(false);
       
       //Asignando datos a elementos ventana trabajador
       frmcliente1.txtid.setText(tablaclientes.getValueAt(fila, 0).toString());
       frmcliente1.txtnombre.setText(tablaclientes.getValueAt(fila, 1).toString());
       frmcliente1.txtapellidos.setText(tablaclientes.getValueAt(fila, 2).toString());
       frmcliente1.txttelefono.setText(tablaclientes.getValueAt(fila, 3).toString());
       frmcliente1.txttelefono2.setText(tablaclientes.getValueAt(fila, 4).toString());
       frmcliente1.txtrfc.setText(tablaclientes.getValueAt(fila, 5).toString());
       frmcliente1.txtcorreo.setText(tablaclientes.getValueAt(fila, 6).toString());
       frmcliente1.txtnegocio.setText(tablaclientes.getValueAt(fila, 7).toString());
       frmcliente1.txtcalle.setText(tablaclientes.getValueAt(fila, 8).toString());
       frmcliente1.txtpoblacion.setText(tablaclientes.getValueAt(fila, 9).toString());
       frmcliente1.txtCP.setText(tablaclientes.getValueAt(fila, 10).toString());
       frmcliente1.txtmunicipio.setText(tablaclientes.getValueAt(fila, 11).toString());
       frmcliente1.txtestado.setText(tablaclientes.getValueAt(fila, 12).toString());
       frmcliente1.cbotipo.setSelectedItem(tablaclientes.getValueAt(fila, 13).toString());
       frmcliente1.cboprecio.setSelectedItem(tablaclientes.getValueAt(fila, 14).toString());
       //Cerrando la ventana      
