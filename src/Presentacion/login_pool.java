...
public class login_pool extends javax.swing.JFrame {
    ...
    try {
        ...
        if(rs.next()){
            ...
            //Esto sirve para tambien poner el numero de caja a la label que contiene la image
            //Esto se debe hacer ya que se copio y pego el elemento...este solo no se visualiza ya que se oculto el color
            ventana.lblidcaja2.setText(combocaja.getSelectedItem().toString());
        ...
        JOptionPane.showMessageDialog(null, ex, "Error de conexión", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                Process p = Runtime.getRuntime().exec ("C:/Program Files (x86)/FARMAMEDIC/eliminar_aria.bat"); 
